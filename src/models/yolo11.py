...
def add_yolo_parser(subparsers, parent_parser,train=False):
    yolo_parser = subparsers.add_parser('yolo11', help='Use Ultralytics YOLO-World model.', parents=[parent_parser])
    # --- Required Arguments ---
    yolo_parser.add_argument('--model', type=str, required=True, 
    ...
    yolo_parser.add_argument('--patience', type=int, default=10, 
                        help="Level of patience for early stopping.")
