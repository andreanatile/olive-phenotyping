...
from src.models.rt_detr import add_rt_detr_parser


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run closed-world object detection model training."
    )
    ...
    add_rt_detr_parser(subparsers, parent_parser, train=True)
